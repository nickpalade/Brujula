// Vendored from React Bits (reactbits.dev, MIT) — PixelCard, JS-CSS variant.
// Local adaptations for Brújula:
//  - `autoAnimate` prop: pixels appear on mount and settle after ~4 s — phones
//    have no hover, and we use this to flag an INCOMING assignment.
//  - default `variant="granate"` added (Field · Bosque palette).
// No dependencies; canvas only. Bundled locally per the offline rule.
